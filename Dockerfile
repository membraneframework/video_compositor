...
COPY --from=0 --chown=$USERNAME:$USERNAME /root/project/target/release/main_process /home/$USERNAME/video_compositor/main_process
COPY --from=0 --chown=$USERNAME:$USERNAME /root/project/target/release/process_helper /home/$USERNAME/video_compositor/process_helper
COPY --from=0 --chown=$USERNAME:$USERNAME /root/project/target/release/lib /home/$USERNAME/video_compositor/lib
COPY --from=0 --chown=$USERNAME:$USERNAME /root/project/docker/entrypoint.sh /home/$USERNAME/video_compositor/entrypoint.sh
